  ...
  try {
    ...
    return(
      ...
      <div style={{height:"100%",width:"100%"}}> 
        ...
        {/* not edit mode */}
        <div style={{ color:'black',paddingTop: '10px', marginLeft: '20px', marginTop: '70px' }}>
          ...
          {/* EDIT MODE */}
          {selectedEvent && isEditMode && (
            <div style={{color:'black',display:'flex',justifyContent:'center', border: '2px solid black', padding: '10px', position: 'relative' }}>
